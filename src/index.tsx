...
import {
  APP_NAME, DEBUG, STRICTERDOM_ENABLED,
} from './config';

// APP_VERSION is defined by webpack DefinePlugin in webpack.config.ts
...
// import { initSolanaDeepLinkHandler, registerSolanaProtocolHandler } from './util/handleSolanaDeepLink';
...
async function init() {
  ...
  requestMutation(() => {
    ...
    // Initialize Solana deep link handler
    // initSolanaDeepLinkHandler();
    // registerSolanaProtocolHandler();
