...
export default {
  ...
  Contacts: 'Contacts',
  Settings: 'Settings',
  CreateOwnKeypair: 'Create Own Keypair',
  RequestTestTokens: 'Request Test Tokens',
  ExportPrivateKey: 'Export Private Key',
  ExportWalletJson: 'Export Wallet JSON',
  Manage: 'Manage',
  WalletExportWarning: 'Warning: This action will delete your wallet and all associated data. This is irreversible.',
  CopyToClipboard: 'Copy to Clipboard',
  Copied: 'Copied',
  ManageWallet: 'Manage Wallet',
  WalletBackup: 'Wallet Backup',
  WalletBackupDescription: 'Backup your wallet to a file for safekeeping.',
  WalletSecurity: 'Wallet Security',
  DeleteWalletDescription: 'Delete your wallet and all associated data. This action is irreversible.',
