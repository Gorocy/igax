...
import { detectIgax } from '../../../util/detectIgax';
import styles from './ChatExtra.module.scss';
import IgaxTransactionContainer from '../../igax/IgaxTransactionContainer';
...
const ChatExtra: FC<OwnProps & StateProps> = ({
  ...
  return (
    <div className="ChatExtra">
      ...
      {/* {description && Boolean(description.length) && detectIgax(description) && ( */}
        {/* <div>{oldLang('IGAX_TRANSACTIONS')}</div> */}
      {/* )} */}

      {/* {description && detectIgax(description) && (
        <IgaxTransactionContainer
          description={description}
        />
      )} */}
      { description && description.length > 0 && detectIgax(description).length > 0 && 
      (<div>
        <IgaxTransactionContainer
          description={description}
        />
